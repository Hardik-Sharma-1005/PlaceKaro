...
export const jobService = {
  ...
  async getJobsByCompany(companyId: string): Promise<Job[]> {
    try {
      ...
      // Silently handled: permission denied // console.debug("Could not fetch jobs (permission denied):", error);
      return [];
    }
  },
  ...
  async getJobById(jobId: string): Promise<Job | null> {
    try {
      ...
      // Silently handled: permission denied // console.debug("Could not fetch job (permission denied):", error);
      return null;
    }
  },
  ...
  async getJobRequirements(jobId: string): Promise<JobRequirements | null> {
    try {
      ...
      // Silently handled: permission denied // console.debug("Could not fetch job requirements (permission denied):", error);
      return null;
    }
  },
